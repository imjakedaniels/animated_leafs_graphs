...
# join results information into the leafs schedule
...
game_data <- leafs_schedule_results %>%
  filter(game_choices == "Toronto vs. Edmonton - Dec 14, 2019") # pick the game you want the chart for
```
...
# save tweets
search_tweets("#TMLTalk OR #LeafsForever OR Leafs OR leafs", 
              n = 15000, 
              include_rts = FALSE, 
...
unwanted_words <- c("10u", "t.co", "amp", "https", "10a", "pas", "att", "gonna", "hes", "ml\U0001f4b5", "lieut", "maple")
...
I scraped all the team logos from wikipedia and stored them in this folder. We make them transparent by multiplying the RGB values by 0.2.
