...
game_data <- leafs_schedule_results %>%
  filter(game_choices == "Toronto vs. N.Y. Rangers - Dec 20, 2019") # pick the game you want the chart for
```
...
# save tweets
search_tweets("#TMLTalk OR #LeafsForever OR Leafs OR leaf's OR #goleafsgo", 
              n = 15000, 
              include_rts = FALSE, 
