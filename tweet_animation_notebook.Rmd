...
```{r input}
# YYYY-MM-DD
game_date <- "2020-02-22"

# What should the tweets contain?
tweet_keywords <- "#TMLTalk OR #LeafsForever OR @MapleLeafs leafs OR #leafs OR #GoLeafsGo OR #mapleleafs"
...
unwanted_words <- c("10u", "t.co", "gotta", "#leafsforever", "games", "leafs", "#tmltalk", "hockey", "dont", "amp", "period", "region", "https", "10a", "pas", "att", "gonna", "ive", "les", "game", "hes", "#leafs", "#goleafsgo", "leaf's", "vai", "ml\U0001f4b5", "lieut", "maple", "vous", "weve", "ill", "theyre", "isnt", "youre")
```
...
```{r}
# x-axis Labels
hourly_ranges <- data.frame(time = seq(min_hour + 1800, max_hour + 1800*4, by = 3600))
...
options(gganimate = options(dpi = 300))
